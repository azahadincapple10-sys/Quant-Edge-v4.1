...
import { BarChart3, Mail, Loader2, AlertCircle, ShieldCheck } from "lucide-react";
      ...
      <div className="z-10 w-full max-w-md px-4">
        ...
        <Card className="border-border/50 bg-card/90 backdrop-blur-xl shadow-2xl">
          <CardHeader className="space-y-1 text-center">
            <CardTitle className="text-2xl font-bold font-headline text-primary">Join the Elite</CardTitle>
            <CardDescription>
              Deploy institutional-grade strategies today
            </CardDescription>
          </CardHeader>
